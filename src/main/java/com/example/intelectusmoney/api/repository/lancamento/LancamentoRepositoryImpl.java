...
import com.example.intelectusmoney.api.model.Categoria_;
import com.example.intelectusmoney.api.model.Lancamento;
import com.example.intelectusmoney.api.model.Lancamento_;
import com.example.intelectusmoney.api.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery{
	...
	private Long total(LancamentoFilter lancamentoFilter) {
		...
		Predicate[] preditcates = criarRestricoes(lancamentoFilter, builder, root);
		criteriaQuery.where(preditcates);
